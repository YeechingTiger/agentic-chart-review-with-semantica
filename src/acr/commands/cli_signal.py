...
#: Every one is `slot: eval` and declares what it may judge; see `acr.contract.skills.eval_skills_block`.
#:
...
#: "Truth mode caps what can be concluded" — it is a ceiling on what a diagnosis may
#: CONCLUDE, and the cards follow from it rather than the other way round.
#:
