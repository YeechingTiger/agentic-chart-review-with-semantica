...
from ..contract.answer_checks import check_field_formats
...
from ..contract.concordance import (
    Guideline,
    VariableValue,
    _Env,
    _eval_all,
...
from ..contract.registry_catalog import (
...
class ModelClassifier:
    ...
    def classify(self, question: str, vocab: dict) -> Classification:
        from ..core.llm import extract_json  # local: keeps litellm off the import path of
...
def _bind_values(values: dict[str, Any], sentinels: dict[str, tuple[str, ...]]
    ...
    """
    from ..contract.concordance import _coerce, _norm  # local: same-module private helpers
...
def spec_skeleton(variable: str, question: str, *, why_not_composable: str = "") -> SpecSkeleton:
    ...
    header = (
        f"# DRAFT SPEC — generated by acr.authoring.intake for a question no shipped spec answers.\n"
