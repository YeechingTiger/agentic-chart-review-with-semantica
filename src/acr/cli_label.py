...
---------------------------
`acr.labelling` is 1292 lines with a test file beside it and, until this module, no way to
...
from . import labelling as lab
from .cli_common import CORPUS, con, dump
