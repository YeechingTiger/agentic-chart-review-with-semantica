...
# `acr.strata` because they are DERIVED FROM THE SPEC and not a retrieval policy: anything that
...
# a compatibility shim — and `acr.strata` is the one definition.
from .strata import StratumSpec, assign_strata, strata_from_spec  # noqa: F401
