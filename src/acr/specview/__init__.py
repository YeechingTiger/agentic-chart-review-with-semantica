...
This file re-exports rather than defines. Callers name `acr.specview` — the CLI, the tests,
and the docstrings in `acr.spec` that point here — and splitting the module must not turn
...
from .statements import (MODEL_AUTHORED, Element, SourceGroup, editorial_index, element_ids,
                         elements, provenance_findings)
