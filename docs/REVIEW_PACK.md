# Review pack — one task contract, two controllers, six tactics

Generated by `tools/make_review_pack.py` at commit `1d63292`. Everything below is pasted verbatim
from the repository.
...
| search policy | `assets/skills/controller-*` (one per run) + `tactic-*` (called on precondition) | independent, slot-assembled |
...
## 2.1  `controller-reactive`  ·  slot: **controller**
...
## 2.2  `controller-information-gain`  ·  slot: **controller**
...
## 2.3  `tactic-query-formulation`  ·  slot: **tactic**
...
## 2.4  `tactic-coverage-pool`  ·  slot: **tactic**
...
## 2.5  `tactic-follow-dependency`  ·  slot: **tactic**
...
## 2.6  `tactic-orient-from-summary`  ·  slot: **tactic**
...
## 2.7  `tactic-counterevidence`  ·  slot: **tactic**
...
## 2.8  `tactic-sample-unknown-types`  ·  slot: **tactic**
...
## 2.9  `experience-adapter`  ·  slot: **experience**
...
## 2.10  `tool-contract`  ·  slot: **general**
