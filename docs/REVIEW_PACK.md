# Review pack — one task contract, two controllers, four tactics

Generated by `tools/make_review_pack.py` at commit `e6777f5`. Everything below is pasted verbatim
from the repository.
...
## 2.7  `experience-adapter`  ·  slot: **experience**
...
## 2.8  `tool-contract`  ·  slot: **general**
